...
namespace WebBodyPiercing.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Piezas_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultas_Piezas_PiezaId",
                        column: x => x.PiezaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favoritos_Piezas_PiezaId",
                        column: x => x.PiezaId,
                        principalTable: "Piezas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Piezas_PiezaId",
                        column: x => x.PiezaId,
                        principalTable: "Piezas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultas_PiezaId",
                table: "Consultas",
                column: "PiezaId");

            migrationBuilder.CreateIndex(
                name: "IX_Favoritos_PiezaId",
                table: "Favoritos",
                column: "PiezaId");
